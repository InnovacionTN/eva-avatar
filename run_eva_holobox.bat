...
echo Starting Eva (caja holografica 9:16 fondo blanco)...  (talk to her in Spanish; press Q in the window to quit)
...
"%PY%" src\eva_platica.py --source assets\eva_body_blanco_916.png --source-max-dim 1600 --out-width 864 --out-height 1536 --preview --no-virtual-cam --vision %*
